...
export default function DownSection() {
    return (
        <div>
                ...
                <div className="container px-5 py-24 mx-auto flex flex-wrap">
                    ...
                    <div className="md:w-3/5 md:pl-6">
                        ...
                        <div className="flex md:mt-4 mt-6">
                            ...
                            <a className="text-blue-500 inline-flex items-center ml-4">Learn More
            ...
            {
                /* <h1>Hello Devanshu in React app</h1>
                <div className="App">
                  <header className="App-header">
                    ...
                    <a
                      className="App-link"
                      href="https://youtube.com/c/TechMayan1"
                      target="_blank"
            ...
            <h1>{d}</h1>
            <h2>Hello everyone in reactApp</h2>
            <div className="contanier">
                <p> Hello,Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolore eligendi optio in, facere debitis temporibus accusamus adipisci ea quaerat aut excepturi, dicta, laudantium voluptatum. Illo ratione saepe nemo vero nostrum!
                </p>
            </div>
            <section className="text-gray-600 body-font">
                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="p-4 md:w-1/2 w-full">
                            <div className="h-full bg-gray-100 p-8 rounded">
                                ...
                                <a className="inline-flex items-center">
                                    <img alt="testimonial" src="https://source.unsplash.com/720x600/?cars" className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
                                    <span className="flex-grow flex flex-col pl-4">
                                        <span className="title-font font-medium text-gray-900">Mayank Varshney</span>
                        ...
                        <div className="p-4 md:w-1/2 w-full">
                            <div className="h-full bg-gray-100 p-8 rounded">
                                ...
                                <p className="leading-relaxed mb-6">Synth chartreuse iPhone lomo cray raw denim brunch everyday carry neutra before they sold out fixie 90's microdosing. Tacos pinterest fanny pack venmo, post-ironic heirloom try-hard pabst authentic iceland.</p>
                                <a className="inline-flex items-center">
                                    <img alt="testimonial" src="https://source.unsplash.com/720x600/?ambani" className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
                                    <span className="flex-grow flex flex-col pl-4">
                                        <span className="title-font font-medium text-gray-900">Devanshu</span>
